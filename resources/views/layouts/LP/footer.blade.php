            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        ...
                        <p class="footer-widget__about-text">Layanan digital terbaik dan terlengkap didukungan tim support profesional untuk kemudahan Anda meraih kesuksesan online!</p>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="footer-widget__column footer-widget__contact">
                        ...
                        <p class="footer-widget__contact-text">Jl. Senen Raya No.1135, Senen, Kota Jakarta Pusat</p>
                        <div class="footer-widget__contact-info">
                            <p>
                                <a href="tel:92-666-888-0000" class="footer-widget__contact-phone">92 666 888
                                    0000</a>
                                <a href="mailto:needhelp@company.com"
                                    class="footer-widget__contact-mail">bientimedia@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
