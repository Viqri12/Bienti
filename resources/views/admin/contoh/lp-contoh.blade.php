...
@include('layouts.LP.navbar')
                            ...
                            <div class="video-overlay header-text">
                                <div class="container">
                                  <div class="row">
                                    ...
                                    <div class="fw-semibold" style="font-size: 30px;">Welcome to bienti media crative agency</div>
                                    <div style="font-size: 50px;" class="fw-bold">A DIGITAL AGENCY <br>WITH A PASSION FOR MARKETING</div>
                                    <div class="ms-2" style="font-size: 20px">Let's Collaborate</div>
                                    <div class="main-button-yellow col-5">
        ...
        <div class = "video1 me-5 me-md-0 object-fit-cover">
            <video controls style="       float: start;
            margin-top: 50px;
            margin-bottom: 50px;
            width: 90%;
            margin-right: 25px;
