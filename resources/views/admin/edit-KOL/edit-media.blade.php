...
<style>
    select {
        ...
        <div class="row border mb-4 col-11 ms-3 bg-white shadow rounded-3">
            ...
            <form action="{{ route('edit-data-media', $id) }}" method="POST">
                @csrf
                <div class="row g-3 mb-2 p-3 col-12">
                    <div class=" col-4 cursor-pointer">
                        ...
                        <div class="">
                            <input required type="text" name="name" value="{{ $data->nama }}"  class=" rounded-2 border form-control bg-transparent p-3 col-12" placeholder="Masukan Jumlah Followers">
                    ...
                    <div class=" col-4 ">
                        ...
                        <div class="">
                            <input type="text" name="ig_story_with_link" value="{{ $data->ig_story_with_link }}" class=" form-control col-12" placeholder="">
                        </div>  
                    </div> 
                    <div class=" col-4 ">
                        <div class="">
                    ...
                    <div class=" col-4">
                        ...
                        <div class="">
                            <input type="text" value="{{ $data->contact_person }}" required name="contact_person" class="form-control col-12" placeholder="https://Instagram">
                        </div> 
                    </div> 
                    <div class=" col-4">
                        <div class="">
